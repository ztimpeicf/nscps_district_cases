...
First, as suggested by a growing body of literature, the spread of airborne disease among children and adolescents attending public schools can be mitigated, which is particularly noteworthy given the concern over consequences to remote-only learning (e.g., learning loss, breaking social ties). While it is still unclear the extent to which individual strategies rank in importance and contribute to reduced spread, it appears that COVID-19 mitigation is achieved in schools when districts develop policies and/or prevention guidance and communicate that schools should utilize a combination of multiple prevention strategies. Furthermore, these results hold after accounting for nesting of schools within state and region, which underscore the differences in students' experiences of the pandemic through a broad environmental backdrop.
